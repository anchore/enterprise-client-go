 ...
 * @param ruleId
*/
func (a *ArchivesApiService) DeleteAnalysisArchiveRule(ctx _context.Context, ruleId string) (*_nethttp.Response, error) {
	var (
...
*/
func (a *ArchivesApiService) DeleteArchivedAnalysis(ctx _context.Context, imageDigest string, localVarOptionals *DeleteArchivedAnalysisOpts) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
