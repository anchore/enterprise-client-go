...
**SourceMappings** | [**[]SourceMappingRule**](SourceMappingRule.md) | Mapping rules for defining which policy and whitelist(s) to apply to a source based on a match of the host and repo name. Evaluated in order. | [optional] 
