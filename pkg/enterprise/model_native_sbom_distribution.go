...
func (o *NativeSBOMDistribution) SetExtendedSupportNil() {
...
func (o *NativeSBOMDistribution) UnmarshalJSON(data []byte) (err error) {
	varNativeSBOMDistribution := _NativeSBOMDistribution{}

	err = json.Unmarshal(data, &varNativeSBOMDistribution)
