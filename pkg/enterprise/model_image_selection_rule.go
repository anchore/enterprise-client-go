...
type _ImageSelectionRule ImageSelectionRule
...
func (o *ImageSelectionRule) UnmarshalJSON(data []byte) (err error) {
	...
	varImageSelectionRule := _ImageSelectionRule{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varImageSelectionRule)

	if err != nil {
		return err
	}

	*o = ImageSelectionRule(varImageSelectionRule)
