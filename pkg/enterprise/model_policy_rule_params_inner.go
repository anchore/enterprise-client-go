...
// checks if the PolicyRuleParamsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyRuleParamsInner{}
...
func (o PolicyRuleParamsInner) ToMap() (map[string]interface{}, error) {
