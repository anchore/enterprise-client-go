...
type PolicyEvaluationResult struct {
	...
	MatchedAllowlistedImagesRule *AnyOfNullTypeImageSelectionRule `json:"matched_allowlisted_images_rule,omitempty"`
	// Whether the evaluated image matched a denylist rule
	ImageDenylisted bool `json:"image_denylisted"`
	MatchedDenylistedImagesRule *AnyOfNullTypeImageSelectionRule `json:"matched_denylisted_images_rule,omitempty"`
	// Whether the evaluated image matched a policy rule
	ImageMappedToRule bool `json:"image_mapped_to_rule"`
	MatchedMappingRule *AnyOfNullTypeMappingRule `json:"matched_mapping_rule,omitempty"`
...
func (o *PolicyEvaluationResult) GetMatchedAllowlistedImagesRule() AnyOfNullTypeImageSelectionRule {
	if o == nil || o.MatchedAllowlistedImagesRule == nil {
		var ret AnyOfNullTypeImageSelectionRule
		return ret
	}
...
// SetMatchedAllowlistedImagesRule gets a reference to the given AnyOfNullTypeImageSelectionRule and assigns it to the MatchedAllowlistedImagesRule field.
...
// SetMatchedDenylistedImagesRule gets a reference to the given AnyOfNullTypeImageSelectionRule and assigns it to the MatchedDenylistedImagesRule field.
...
func (o *PolicyEvaluationResult) GetMatchedMappingRule() AnyOfNullTypeMappingRule {
	if o == nil || o.MatchedMappingRule == nil {
		var ret AnyOfNullTypeMappingRule
		return ret
	}
...
// SetMatchedMappingRule gets a reference to the given AnyOfNullTypeMappingRule and assigns it to the MatchedMappingRule field.
