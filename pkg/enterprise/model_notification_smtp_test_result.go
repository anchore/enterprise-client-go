...
// checks if the NotificationSMTPTestResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationSMTPTestResult{}
...
func (o NotificationSMTPTestResult) ToMap() (map[string]interface{}, error) {
