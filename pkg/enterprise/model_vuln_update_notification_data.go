...
// checks if the VulnUpdateNotificationData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VulnUpdateNotificationData{}
...
type _VulnUpdateNotificationData VulnUpdateNotificationData
...
func (o VulnUpdateNotificationData) ToMap() (map[string]interface{}, error) {
...
func (o *VulnUpdateNotificationData) UnmarshalJSON(data []byte) (err error) {
	varVulnUpdateNotificationData := _VulnUpdateNotificationData{}

	err = json.Unmarshal(data, &varVulnUpdateNotificationData)

	if err != nil {
		return err
	}

	*o = VulnUpdateNotificationData(varVulnUpdateNotificationData)
