...
type ArtifactLifeCyclePolicyList struct {
	Items *[]ArtifactLifeCyclePolicy `json:"items,omitempty"`
}
...
func (o *ArtifactLifeCyclePolicyList) GetItems() []ArtifactLifeCyclePolicy {
	if o == nil || o.Items == nil {
		var ret []ArtifactLifeCyclePolicy
		return ret
	}
	return *o.Items
}
...
// SetItems gets a reference to the given []ArtifactLifeCyclePolicy and assigns it to the Items field.
