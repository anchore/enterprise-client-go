...
type _CVSSV3Scores CVSSV3Scores
...
func (o *CVSSV3Scores) UnmarshalJSON(data []byte) (err error) {
	varCVSSV3Scores := _CVSSV3Scores{}

	err = json.Unmarshal(data, &varCVSSV3Scores)

	if err != nil {
		return err
	}

	*o = CVSSV3Scores(varCVSSV3Scores)
