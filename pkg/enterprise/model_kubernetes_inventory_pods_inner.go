...
// checks if the KubernetesInventoryPodsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesInventoryPodsInner{}
...
func (o KubernetesInventoryPodsInner) ToMap() (map[string]interface{}, error) {
