...
`func (o *ContentPackageResponseContentInner) GetImplementationVersion() string`
...
`func (o *ContentPackageResponseContentInner) GetImplementationVersionOk() (*string, bool)`
...
`func (o *ContentPackageResponseContentInner) SetImplementationVersion(v string)`

SetImplementationVersion sets ImplementationVersion field to given value.

### HasImplementationVersion

`func (o *ContentPackageResponseContentInner) HasImplementationVersion() bool`

HasImplementationVersion returns a boolean if a field has been set.

### GetSpecificationVersion

`func (o *ContentPackageResponseContentInner) GetSpecificationVersion() string`

GetSpecificationVersion returns the SpecificationVersion field if non-nil, zero value otherwise.

### GetSpecificationVersionOk

`func (o *ContentPackageResponseContentInner) GetSpecificationVersionOk() (*string, bool)`
...
`func (o *ContentPackageResponseContentInner) SetSpecificationVersion(v string)`

SetSpecificationVersion sets SpecificationVersion field to given value.

### HasSpecificationVersion

`func (o *ContentPackageResponseContentInner) HasSpecificationVersion() bool`

HasSpecificationVersion returns a boolean if a field has been set.

### GetMavenVersion

`func (o *ContentPackageResponseContentInner) GetMavenVersion() string`

GetMavenVersion returns the MavenVersion field if non-nil, zero value otherwise.

### GetMavenVersionOk

`func (o *ContentPackageResponseContentInner) GetMavenVersionOk() (*string, bool)`
...
`func (o *ContentPackageResponseContentInner) SetMavenVersion(v string)`

SetMavenVersion sets MavenVersion field to given value.

### HasMavenVersion

`func (o *ContentPackageResponseContentInner) HasMavenVersion() bool`
