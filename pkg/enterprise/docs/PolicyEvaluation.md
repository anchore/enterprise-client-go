...
**Evaluations** | Pointer to [**[]PolicyEvaluationResult**](PolicyEvaluationResult.md) | List of policy evaluations. Always has at least one result, may contain multiple when the evaluation history is requested. | [optional] 
