...
func main() {
    artifactLifecyclePolicy := *openapiclient.NewArtifactLifecyclePolicy("Action_example", "Name_example", *openapiclient.NewArtifactLifecyclePolicyConditions(false, int32(123), false, "ArtifactType_example")) // ArtifactLifecyclePolicy |  (optional)
