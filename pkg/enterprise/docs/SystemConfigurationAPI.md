...
func main() {
	systemConfigurationPatchInner := []openapiclient.SystemConfigurationPatchInner{*openapiclient.NewSystemConfigurationPatchInner("Key_example", *openapiclient.NewSystemConfigurationValue())} // []SystemConfigurationPatchInner |  (optional)
...
func main() {
	configKey := "configKey_example" // string | 
	systemConfigurationPut := *openapiclient.NewSystemConfigurationPut("Key_example", *openapiclient.NewSystemConfigurationValue()) // SystemConfigurationPut |  (optional)
