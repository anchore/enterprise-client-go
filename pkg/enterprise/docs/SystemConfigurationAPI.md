...
func main() {
	systemConfigurationPatchInner := []openapiclient.SystemConfigurationPatchInner{*openapiclient.NewSystemConfigurationPatchInner("Key_example", "TODO")} // []SystemConfigurationPatchInner |  (optional)
...
func main() {
	configKey := "configKey_example" // string | 
	systemConfigurationPut := *openapiclient.NewSystemConfigurationPut("Key_example", "TODO") // SystemConfigurationPut |  (optional)
