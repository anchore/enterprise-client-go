...
// checks if the NotificationEndpointConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationEndpointConfiguration{}
...
func (o NotificationEndpointConfiguration) ToMap() (map[string]interface{}, error) {
