...
type _ArchiveSummary ArchiveSummary
...
func (o *ArchiveSummary) UnmarshalJSON(data []byte) (err error) {
	varArchiveSummary := _ArchiveSummary{}

	err = json.Unmarshal(data, &varArchiveSummary)

	if err != nil {
		return err
	}

	*o = ArchiveSummary(varArchiveSummary)
