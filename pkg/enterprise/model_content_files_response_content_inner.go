...
// checks if the ContentFilesResponseContentInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContentFilesResponseContentInner{}
...
func (o ContentFilesResponseContentInner) ToMap() (map[string]interface{}, error) {
