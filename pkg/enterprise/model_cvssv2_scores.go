...
// checks if the CVSSV2Scores type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CVSSV2Scores{}
...
func (o CVSSV2Scores) ToMap() (map[string]interface{}, error) {
