...
*ArtifactLifecyclePoliciesApi* | [**CreateArtifactLifecyclePolicy**](docs/ArtifactLifecyclePoliciesApi.md#createartifactlifecyclepolicy) | **Post** /system/artifact-lifecycle-policies | Create new artifact lifecycle policy
*ArtifactLifecyclePoliciesApi* | [**DeleteArtifactLifecyclePolicy**](docs/ArtifactLifecyclePoliciesApi.md#deleteartifactlifecyclepolicy) | **Delete** /system/artifact-lifecycle-policies/{policy_uuid} | Delete lifecycle policy
*ArtifactLifecyclePoliciesApi* | [**GetArtifactLifecyclePolicy**](docs/ArtifactLifecyclePoliciesApi.md#getartifactlifecyclepolicy) | **Get** /system/artifact-lifecycle-policies/{policy_uuid} | Get single artifact lifecycle policy
*ArtifactLifecyclePoliciesApi* | [**GetArtifactLifecyclePolicyByVersion**](docs/ArtifactLifecyclePoliciesApi.md#getartifactlifecyclepolicybyversion) | **Get** /system/artifact-lifecycle-policies/{policy_uuid}/versions | Get single artifact lifecycle policy by its version
*ArtifactLifecyclePoliciesApi* | [**ListArtifactLifecyclePolicies**](docs/ArtifactLifecyclePoliciesApi.md#listartifactlifecyclepolicies) | **Get** /system/artifact-lifecycle-policies | List all artifact lifecycle policies
*ArtifactLifecyclePoliciesApi* | [**UpdateArtifactLifecyclePolicy**](docs/ArtifactLifecyclePoliciesApi.md#updateartifactlifecyclepolicy) | **Put** /system/artifact-lifecycle-policies/{policy_uuid} | Update a single artifact lifecycle policy
