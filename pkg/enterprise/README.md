...
*SystemConfigurationAPI* | [**GetConfigurationSchema**](docs/SystemConfigurationAPI.md#getconfigurationschema) | **Get** /system/configurations/schema | Get the system configuration schema
