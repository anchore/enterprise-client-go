...
type SystemAPI interface {
	...
	*/
	...
	/*
	GetStigProfiles Download STIG profiles database

	Retrieve the latest STIG profiles database for airgap environments

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetStigProfilesRequest
	*/
	GetStigProfiles(ctx context.Context) ApiGetStigProfilesRequest

	// GetStigProfilesExecute executes the request
	//  @return *os.File
	GetStigProfilesExecute(r ApiGetStigProfilesRequest) (*os.File, *http.Response, error)
...
type ApiGetStigProfilesRequest struct {
	ctx context.Context
	ApiService SystemAPI
}

func (r ApiGetStigProfilesRequest) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.GetStigProfilesExecute(r)
}
...
Retrieve the latest STIG profiles database for airgap environments
 ...
 @return ApiGetStigProfilesRequest
*/
func (a *SystemAPIService) GetStigProfiles(ctx context.Context) ApiGetStigProfilesRequest {
	return ApiGetStigProfilesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return *os.File
func (a *SystemAPIService) GetStigProfilesExecute(r ApiGetStigProfilesRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SystemAPIService.GetStigProfiles")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stig-profiles"
