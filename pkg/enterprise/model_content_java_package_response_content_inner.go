...
// checks if the ContentJAVAPackageResponseContentInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContentJAVAPackageResponseContentInner{}
...
func (o ContentJAVAPackageResponseContentInner) ToMap() (map[string]interface{}, error) {
