...
// checks if the RbacManagerSamlConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RbacManagerSamlConfiguration{}
...
func (o RbacManagerSamlConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *RbacManagerSamlConfiguration) UnmarshalJSON(data []byte) (err error) {
