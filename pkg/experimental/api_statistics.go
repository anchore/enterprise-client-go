...
type StatisticsAPI interface {
	...
	Returns list of system statistics with total all-time counts. A time-based breakdown will be included if the detail parameter is set to True.
...
// Include time-based breakdown of statistics
func (r ApiGetSystemStatisticsRequest) Detail(detail bool) ApiGetSystemStatisticsRequest {
	r.detail = &detail
	return r
}
